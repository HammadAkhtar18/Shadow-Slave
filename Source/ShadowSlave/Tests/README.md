...
├── ShadowSlaveAspectTests.cpp        # Generic Aspect ability activation, resource validation, transient state behavior, and Aspect/Ability/Flaw definition content pipeline integration
